...
<html>
    <head>
        ...
        <title>Admin Panel - Edit Campaign</title>
        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="body-wrapper">
                ...
                <%
                    ...
                    List<Integer> items = (List<Integer>) request.getAttribute("items");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="promotionForm" method="post" action="${pageContext.request.contextPath}/admin/edit-campaign" onsubmit="return validateForm()">
                                <input type="hidden" value="<%= campaign.getId() %>" name="campaignId" >
                                <div class="form-group-inline mb-3">
                                    <label for="promotionName" class="form-label">Promotion Name</label>
                                    <input type="text" class="form-control" id="promotionName" name="promoName" value="<%= campaign.getCampaignName() %>" required>
                                </div>
                                <div class="form-group-inline mb-3">
                                    <label for="promotionDateStart" class="form-label">Date Start</label>
                                    <input type="date" class="form-control date-input" id="promotionDateStart" name="startDate" value="<%= campaign.getDateStart() %>">
                                </div>
                                <div class="form-group-inline mb-3">
                                    <label for="promotionDateEnd" class="form-label">Date End</label>
                                    <input type="date" class="form-control date-input" id="promotionDateEnd" name="endDate" value="<%= campaign.getDateEnd() %>">
                                </div>
                                <div class="form-group-inline mb-3">
                                    ...
                                    <input type="number" class="form-control quantity-input" id="promotionDiscount"
                                           max="100" min="0" name="percentageDiscount" value="<%= campaign.getDiscountPercentage() %>">
                                </div>
                                <div class="form-group-inline mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div id="productList" class="form-check">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input product-checkbox" type="checkbox" value="<%= product.getId()%>" id="product-<%= product.getId()%>" <%= items.contains(product.getId()) ? "checked" : "" %>>
